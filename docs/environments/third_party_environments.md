...
- [WireHarness-MultiAgent-RL: Multi-agent wire harness routing in MuJoCo](https://github.com/ludwigstr/WireHarness-MultiAgent-RL)
  ...
  Five planar movers must coordinate to navigate cable harnesses to predefined target configurations on an assembly board without causing cable collisions.
